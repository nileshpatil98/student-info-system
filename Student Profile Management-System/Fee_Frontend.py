...
class Fee():
    def __init__(self, master):
        ...
        # ==================================================Frames===================================================
        Main_Frame = Frame(self.master, bg='bisque3')
        Main_Frame.grid()

        Title_Frame = LabelFrame(
            Main_Frame, width=1350, height=100, bg='bisque3', relief='ridge', bd=15)
        ...
        Data_Frame = Frame(Main_Frame, width=1350, height=350,
                           bg='bisque3', relief='ridge', bd=15)
        Data_Frame.pack(side=TOP, padx=15)

        Frame_1 = LabelFrame(Data_Frame, width=850, height=350, bg='bisque3', relief='ridge', bd=8,
                             text='Informations', font=('arial', 15, 'bold'))
        Frame_1.pack(side=LEFT, padx=10)

        Frame_2 = LabelFrame(Data_Frame, width=495, height=350, bg='bisque3', relief='ridge', bd=8,
